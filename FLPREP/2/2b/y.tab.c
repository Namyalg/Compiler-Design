...
{
  "\"end of file\"", "error", "\"invalid token\"", "plus", "mult", "num",
  "sub", "divi", "op", "cp", "$accept", "S", "E", "T", "F", YY_NULLPTR
};
