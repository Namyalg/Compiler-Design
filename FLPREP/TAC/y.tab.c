...
{
  "\"end of file\"", "error", "\"invalid token\"", "num", "plus", "sub",
  "di", "mul", "div", "mult", "$accept", "S", "expr", YY_NULLPTR
};
...
#line 27 "yacc.y"
                      {(yyval.sym) = toTAC((char)(yyvsp[-2].sym), (char)(yyvsp[0].sym), (char)(yyvsp[-1].sym));}
#line 1148 "y.tab.c"
    break;
